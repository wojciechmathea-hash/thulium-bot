...
function verifyWebhookBasicAuth(req, res, next) {
  ...
  // Jeżeli nie ustawisz Basic Auth dla webhooków, endpoint będzie przyjmował webhooki bez auth.
  // Na produkcji zalecane jest ustawienie obu wartości i włączenie Auth Basic w panelu Thulium.
