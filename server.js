...
const VERSION = "1.1.0-agent-login";
const SENDER_VERSION = "v1.1.0-per-user-agent-login";
...
app.post("/api/ticket-send-final", requireExtensionKey, async (req, res) => {
  try {
    const { ticketId, content, categoryId = null, categoryName = null, closeTicket = true, dryRun = false, agentLogin = null } = req.body || {};
